...
const socialLinks = [
  {
    name: 'Instagram',
    icon: Instagram,
    handle: 'empiretecdigital',
    url: 'https://instagram.com/empiretecdigital',
  ...
  },
  {
    name: 'Facebook',
    icon: Facebook,
    handle: 'Empire Tec Digital Media',
    url: 'https://facebook.com/empiretecdigitalmedia',
  ...
  },
  {
    ...
    url: 'https://linkedin.com/company/empiretecllc',
